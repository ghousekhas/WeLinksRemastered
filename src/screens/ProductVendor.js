...
// List of products available with the selected vendor
...
const renderContent = (section, _, isactive) => {
    ...
    return (
        <Animatable.View
            ...
            <ProductsList navigation={navigation} data={section[(Object.keys(section))[0]]} />
        </Animatable.View>);
...
const renderHeader = (section, _, isActive) => {
    ...
    let expanderButton = (<Entypo name='triangle-down' size={20} color={'black'} />)
...
const setSectionsFunction = (sections) => {
 ...
 return (<View style={{ ...StyleSheet.absoluteFill }}>
    <View>
        <AppBar title={vendorData.vendorName} back funct={() => {
...
<Vendor style={{ height: '40%', width: '80%', alignSelf: 'center' }} buttonVisible={false} name={vendorData.vendorName} reviews={vendorData.vendorReviews} stars={vendorData.vendorStars} address={vendorData.vendorAddress} imageUrl={vendorData.imageUrl} />
