    ...
    <AppBar title={'Cancel Tender'} back funct={() => {navigation.pop()}}/>
        <View style={{...Styles.parentContainer}}>
            ...
            <View style={{flexDirection: 'row',justifyContent: 'space-around'}}>
                <TouchableOpacity onPress={()=>onButton('cancel')} style={{backgroundColor: Colors.red,flex: 1,padding: 10,marginLeft: 30,marginRight: 10,alignItems: 'center',justifyContent: 'center',borderRadius: 7}}>
