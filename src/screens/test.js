...
const MySubscriptionOrder = ({name,pickUpDate,orderAmount,orderDate,imageUrl,status,cart,address}) => {
  ...
  //  console.log(arr)
    ...
    borderWidth: 1,borderRadius: 8,alignSelf: 'center',minHeight: dimen.height/3.6,padding:'2%',backgroundColor:'white'}}>
...
<Text numberOfLines={5} style={{fontWeight: 'normal',fontSize:13,paddingVertical:'4%'}}>{address}</Text>
    ...
    <ScrollView style={{backgroundColor: 'purple'}}>
        <View style={{...Styles.parentContainer,marginBottom: '20%',padding: tag == 'User'?'3%':0}}>
            ...
            <View style={{flexDirection :'row',justifyContent: 'space-around',marginTop: dimen.height/2-100}}>
