...
export default class VendorScrapOrder extends React.Component{
        ...
        const cart = [
            {
                ...
                "cart_quantity": "1",
                "cart_product_id": "1",
                "homescrap_name": "Laptop Scrap",
                "homescrap_price": "700",
                "homescrap_image_url": "https://dev.we-link.in/dist/img/products/homescrap_product_1602576194.jpg"
            },
            {
                "cart_id": "44",
                "cart_quantity": "1",
        ...
        const renderHeader=()=>{
            return(
                <View style={{flexDirection: 'column'}}>
                    <MapView
                        style={{height: 300,width: dimen.width-30,margin: 20,padding: 20,alignSelf: 'center'}}
                    />
                </View>
            )
        }
