      ...
      return (
        ...
        <NavigationContainer independent={true}>
          <Drawer.Navigator initialRouteName={initialRoute}
            drawerContent={(props) => {
              return (
              <DrawerContent {...props} getUserDetails={getUserDetails} setDefault={setDefaultValues} getVendorDetails={getVendorDetails} setUser={setUser} actualUser={updateState} switchVendor={switchVendorApp} initVendor={vendor} cachedData={{
                termsData: termsData,
    ...
    return (
        <NavigationContainer independent={true}   >
          <Drawer.Navigator initialRouteName={initialRoute}
            ...
            <Drawer.Screen name="HomeStack" component={Homestack} initialParams={{ user: user, actualUser: updateState, sm: 1, getUserDetails: getUserDetails, ...initialParams }} />
