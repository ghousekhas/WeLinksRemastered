...
const Item = ({ name, quantity, price, price_, imageUrl, tag }) => {
        ...
        <View style={{ flexDirection: 'row', backfaceVisibility: Colors.secondary, paddingVertical: dimen.mVm }}>
            ...
            <View style={style.container}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 0 }}>
                    ...
                    {price_ != null && price_ != undefined && price_ != '' ?
                        <View style={{flex:1,borderRadius:1}}>
                            ...
                            <Text  style={{...style.price,marginVertical: 0,paddingVertical:0,fontSize:12,alignSelf: 'center'}}>{"Weekends- ₹" + price}</Text>
                            </View>
                            <Text style={{ ...style.quantity,fontWeight: 'bold',margin:0,padding:0,alignSelf:'center',padding:0 }}>· </Text>

                            <Text style={{ ...style.quantity,alignSelf: 'center',padding:0 }}>{quantity + (tag == 'Paper' ? ' unit/s' : '')}</Text>
                            ...
                            <Text style={{...style.price,marginVertical: 0,paddingVertical:0,fontSize:12,alignSelf: 'center'}}>{"Weekdays- ₹" + price_}</Text>
                           </View>
                            <Text style={{ ...style.quantity,fontWeight: 'bold',alignSelf: 'center',padding:0 }}>· </Text>
                            <Text style={{ ...style.quantity,alignSelf:'center',padding:0 }}>{quantity + (tag == 'Paper' ? ' unit/s' : '')}</Text>
